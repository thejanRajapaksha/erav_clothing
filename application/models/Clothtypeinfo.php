<?php
class Clothtypeinfo extends CI_Model{
    public function Clothtypeinsertupdate(){
        ...
        if($recordOption==1){
            ...
            $this->db->where('idtbl_cloth', $recordID);
            $this->db->update('tbl_cloth', $data);
    ...
    public function Clothtypeedit(){
        ...
        $obj=new stdClass();
        $obj->id=$respond->row(0)->idtbl_cloth;
