            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-9">
                        ...
                        <button id="saveBalanceDetails" class="btn btn-primary">Save Material Balance</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#mtype").select2({  
            ...
            ajax: {
                url: "<?php echo base_url() ?>Materialdetail/Getmaterialcategory",
                type: "post",
                dataType: 'json',
                delay: 250,
    ...
    $('#btncreateorder').click(function() {
        ...
        if (tbody.children().length > 0) {
            ...
            $.ajax({
                ...
                processData: false,
                contentType: false,
                url: '<?php echo base_url() ?>Materialdetail/Materialdetailinsertupdate',
    ...
    $('#saveBalanceDetails').on('click', function() {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>Materialdetail/Savematerialbalances",
            type: 'POST',
